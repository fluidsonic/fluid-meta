// ------------------------------------------------------------------------------------------------------
// Example output for all elements for Kotlin's Standard Library 1.3.20
// ------------------------------------------------------------------------------------------------------
...
module `kotlin-stdlib` {
	...
	package kotlin {
		...
		/* multipart */ class MathKt {

			/* part */ class MathKt__BigDecimalsKt
			/* part */ class MathKt__BigIntegersKt
			/* part */ class MathKt__NumbersKt
		}
	...
	package kotlin.collections {
		...
		/* multipart */ class UArraysKt {

			/* part */ class UArraysKt___UArraysKt
		}
	}

	package kotlin.comparisons {

		/* multipart */ class kotlin.comparisons.ComparisonsKt {

			/* part */ class kotlin.comparisons.ComparisonsKt__ComparisonsKt
			/* part */ class kotlin.comparisons.ComparisonsKt___ComparisonsJvmKt
			/* part */ class kotlin.comparisons.ComparisonsKt___ComparisonsKt
		}
	}
	...
	package kotlin.ranges {
		...
		/* multipart */ class RangesKt {
			...
			/* part */ class RangesKt__RangesJVMKt
...
module `kotlin-stdlib_coroutinesExperimental` {

	package kotlin.coroutines.experimental {

		/* multipart */ class kotlin.coroutines.experimental.SequenceBuilderKt {

			/* part */ class kotlin.coroutines.experimental.SequenceBuilderKt__SequenceBuilderKt
		}
	}

	package kotlin.coroutines.experimental.intrinsics {

		/* multipart */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt {

			/* part */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsJvmKt
			/* part */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsKt
		}
	}
...
inline class kotlin.UInt : Comparable<UInt> {
	...
	// JVM field = data:I
	// JVM annotation-holding method = data$annotations()V
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inc-impl(I)I
	inline operator fun inc(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inv-impl(I)I
	inline fun inv(): UInt
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = shl-impl(II)I
	inline infix fun shl(bitCount: Int): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = shr-impl(II)I
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUByte-impl(I)B
	inline fun toUByte(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUInt-impl(I)I
	inline fun toUInt(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toULong-impl(I)J
	inline fun toULong(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUShort-impl(I)S
...
inline class kotlin.ULong : Comparable<ULong> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inc-impl(J)J
	inline operator fun inc(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inv-impl(J)J
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = shl-impl(JI)J
	inline infix fun shl(bitCount: Int): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = shr-impl(JI)J
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUByte-impl(J)B
	inline fun toUByte(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUInt-impl(J)I
	inline fun toUInt(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toULong-impl(J)J
	inline fun toULong(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUShort-impl(J)S
	inline fun toUShort(): UShort
...
abstract class kotlin.collections.UIntIterator : Iterator<UInt> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = next()Lkotlin/UInt;
	operator fun next(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = nextUInt()I
...
abstract class kotlin.collections.UByteIterator : Iterator<UByte> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = next()Lkotlin/UByte;
	operator fun next(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = nextUByte()B
...
abstract class kotlin.collections.UShortIterator : Iterator<UShort> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = next()Lkotlin/UShort;
	operator fun next(): UShort

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = nextUShort()S
...
abstract class kotlin.collections.ULongIterator : Iterator<ULong> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = next()Lkotlin/ULong;
	operator fun next(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = nextULong()J
...
private class kotlin.collections.RingBuffer<T> : AbstractList<T>, RandomAccess /* = java.util.RandomAccess */ {
	...
	// JVM method = <init>(I)V
	/* primary */ constructor(capacity: Int)
	...
	private fun <T> Array<T>.fill(element: T, fromIndex: Int /* = default */, toIndex: Int /* = default */)
...
inline class kotlin.UShortArray : Collection<UShort> {
	...
	// JVM field = storage:[S
	// JVM annotation-holding method = storage$annotations()V
...
abstract class kotlin.jvm.internal.PrimitiveSpreadBuilder<T : Any> {
	...
	// JVM annotation-holding method = spreads$annotations()V
...
class kotlin.jvm.internal.ClassReference : kotlin.reflect.KClass<Any>, kotlin.jvm.internal.ClassBasedDeclarationContainer {
	...
	// JVM annotation-holding method = sealedSubclasses$annotations()V
...
inline class kotlin.Result<out T> : Serializable /* = java.io.Serializable */ {
	...
	// JVM field = value:Ljava/lang/Object;
	// JVM annotation-holding method = value$annotations()V
...
inline class kotlin.UByte : Comparable<UByte> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inc-impl(B)B
	inline operator fun inc(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inv-impl(B)B
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUByte-impl(B)B
	inline fun toUByte(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUInt-impl(B)I
	inline fun toUInt(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toULong-impl(B)J
	inline fun toULong(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUShort-impl(B)S
	inline fun toUShort(): UShort
...
inline class kotlin.UShort : Comparable<UShort> {
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inc-impl(S)S
	inline operator fun inc(): UShort

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = inv-impl(S)S
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUByte-impl(S)B
	inline fun toUByte(): UByte

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUInt-impl(S)I
	inline fun toUInt(): UInt

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toULong-impl(S)J
	inline fun toULong(): ULong

	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = toUShort-impl(S)S
	inline fun toUShort(): UShort
...
abstract class kotlin.properties.ObservableProperty<T> : kotlin.properties.ReadWriteProperty<Any?, T> {
	...
	// JVM method = <init>(Ljava/lang/Object;)V
	/* primary */ constructor(initialValue: T)


	// *** FUNCTIONS ***

	// JVM method = afterChange(Lkotlin/reflect/KProperty;Ljava/lang/Object;Ljava/lang/Object;)V
	protected open fun afterChange(property: kotlin.reflect.KProperty<*>, oldValue: T, newValue: T)

	// JVM method = beforeChange(Lkotlin/reflect/KProperty;Ljava/lang/Object;Ljava/lang/Object;)Z
	protected open fun beforeChange(property: kotlin.reflect.KProperty<*>, oldValue: T, newValue: T): Boolean

	// JVM method = getValue(Ljava/lang/Object;Lkotlin/reflect/KProperty;)Ljava/lang/Object;
	open operator fun getValue(thisRef: Any?, property: kotlin.reflect.KProperty<*>): T

	// JVM method = setValue(Ljava/lang/Object;Lkotlin/reflect/KProperty;Ljava/lang/Object;)V
	open operator fun setValue(thisRef: Any?, property: kotlin.reflect.KProperty<*>, value: T)
}
...
class kotlin.ranges.ULongRange : ULongProgression, ClosedRange<ULong> {
	...
	open val endInclusive: ULong
		// JVM method = getEndInclusive()Lkotlin/ULong;
		get() = /* non-default */

	// requires language version >= 1.3, otherwise diagnostic error
	open val start: ULong
		// JVM method = getStart()Lkotlin/ULong;
		get() = /* non-default */
...
class kotlin.ranges.UIntRange : UIntProgression, ClosedRange<UInt> {
	...
	open val endInclusive: UInt
		// JVM method = getEndInclusive()Lkotlin/UInt;
		get() = /* non-default */

	// requires language version >= 1.3, otherwise diagnostic error
	open val start: UInt
		// JVM method = getStart()Lkotlin/UInt;
		get() = /* non-default */
...
/* local */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1 : kotlin.coroutines.experimental.Continuation<Unit> {

	// *** PROPERTIES ***

	open val context: kotlin.coroutines.experimental.CoroutineContext
		// JVM method = getContext()Lkotlin/coroutines/experimental/CoroutineContext;
		get() = /* non-default */


	// *** FUNCTIONS ***

	// JVM method = resume(Lkotlin/Unit;)V
	open fun resume(value: Unit)

	// JVM method = resumeWithException(Ljava/lang/Throwable;)V
	open fun resumeWithException(exception: Throwable)
}

// ------------------------------------------------------------------------------------------------------

// anonymous object origin: kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1
/* local */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt__IntrinsicsJvmKt$buildContinuationByInvokeCall$continuation$1 : kotlin.coroutines.experimental.Continuation<Unit> {
	...
	// JVM method = resumeWithException(L;)V
	open fun resumeWithException(exception: )
}
...
private class kotlin.coroutines.experimental.SequenceBuilderIterator<T> :
	kotlin.coroutines.experimental.SequenceBuilder<T>,
	Iterator<T>,
	...
	// JVM field = nextStep:Lkotlin/coroutines/experimental/Continuation;
	var nextStep: kotlin.coroutines.experimental.Continuation<Unit>?

	// JVM field = nextValue:Ljava/lang/Object;
	private var nextValue: T?

	// JVM field = state:I
	private var state: kotlin.coroutines.experimental.State /* = Int */
	...
	// requires language version >= 1.1, otherwise diagnostic error
	// JVM method = yield(Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	open suspend fun yield(value: T)

	// requires language version >= 1.1, otherwise diagnostic error
	// JVM method = yieldAll(Ljava/util/Iterator;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	open suspend fun yieldAll(iterator: Iterator<T>)
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalSuspendFunction1Migration<T1, R> : (T1, kotlin.coroutines.experimental.Continuation<R>) -> Any? {

	// *** PROPERTIES ***

	// JVM field = function:Lkotlin/jvm/functions/Function2;
	val function: (T1, kotlin.coroutines.Continuation<R>) -> Any?


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/jvm/functions/Function2;)V
	/* primary */ constructor(function: (T1, kotlin.coroutines.Continuation<R>) -> Any?)


	// *** FUNCTIONS ***

	// JVM method = invoke(Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	open operator fun invoke(t1: T1, continuation: kotlin.coroutines.experimental.Continuation<R>): Any?
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalSuspendFunction0Migration<R> : (kotlin.coroutines.experimental.Continuation<R>) -> Any? {

	// *** PROPERTIES ***

	// JVM field = function:Lkotlin/jvm/functions/Function1;
	val function: (kotlin.coroutines.Continuation<R>) -> Any?


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/jvm/functions/Function1;)V
	/* primary */ constructor(function: (kotlin.coroutines.Continuation<R>) -> Any?)


	// *** FUNCTIONS ***

	// JVM method = invoke(Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	open operator fun invoke(continuation: kotlin.coroutines.experimental.Continuation<R>): Any?
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalSuspendFunction2Migration<T1, T2, R> : (T1, T2, kotlin.coroutines.experimental.Continuation<R>) -> Any? {

	// *** PROPERTIES ***

	// JVM field = function:Lkotlin/jvm/functions/Function3;
	val function: (T1, T2, kotlin.coroutines.Continuation<R>) -> Any?


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/jvm/functions/Function3;)V
	/* primary */ constructor(function: (T1, T2, kotlin.coroutines.Continuation<R>) -> Any?)


	// *** FUNCTIONS ***

	// JVM method = invoke(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	open operator fun invoke(t1: T1, t2: T2, continuation: kotlin.coroutines.experimental.Continuation<R>): Any?
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalContinuationMigration<T> : kotlin.coroutines.experimental.Continuation<T> {

	// *** PROPERTIES ***

	// JVM field = context:Lkotlin/coroutines/experimental/CoroutineContext;
	open val context: kotlin.coroutines.experimental.CoroutineContext

	// JVM field = continuation:Lkotlin/coroutines/Continuation;
	...
	// JVM method = <init>(Lkotlin/coroutines/Continuation;)V
	/* primary */ constructor(continuation: kotlin.coroutines.Continuation<T>)


	// *** FUNCTIONS ***

	// JVM method = resume(Ljava/lang/Object;)V
...
private class kotlin.coroutines.experimental.migration.ContinuationMigration<T> : kotlin.coroutines.Continuation<T> {

	// *** PROPERTIES ***

	// JVM field = context:Lkotlin/coroutines/CoroutineContext;
	open val context: kotlin.coroutines.CoroutineContext

	// JVM field = continuation:Lkotlin/coroutines/experimental/Continuation;
	val continuation: kotlin.coroutines.experimental.Continuation<T>


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/experimental/Continuation;)V
	/* primary */ constructor(continuation: kotlin.coroutines.experimental.Continuation<T>)
	...
	// requires language version >= 1.3, otherwise diagnostic error
	// JVM method = resumeWith(Ljava/lang/Object;)V
	open fun resumeWith(result: Result<T>)
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ContinuationInterceptorMigration : kotlin.coroutines.ContinuationInterceptor {

	// *** PROPERTIES ***

	// JVM field = interceptor:Lkotlin/coroutines/experimental/ContinuationInterceptor;
	val interceptor: kotlin.coroutines.experimental.ContinuationInterceptor

	open val key: kotlin.coroutines.CoroutineContext.Key<*>
		// JVM method = getKey()Lkotlin/coroutines/CoroutineContext$Key;
		get() = /* non-default */


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/experimental/ContinuationInterceptor;)V
	/* primary */ constructor(interceptor: kotlin.coroutines.experimental.ContinuationInterceptor)


	// *** FUNCTIONS ***

	// JVM method = interceptContinuation(Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
	open fun <T> interceptContinuation(continuation: kotlin.coroutines.Continuation<T>): kotlin.coroutines.Continuation<T>
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ContextMigration : kotlin.coroutines.AbstractCoroutineContextElement {
	...
	// JVM field = context:Lkotlin/coroutines/experimental/CoroutineContext;
	val context: kotlin.coroutines.experimental.CoroutineContext


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/experimental/CoroutineContext;)V
	/* primary */ constructor(context: kotlin.coroutines.experimental.CoroutineContext)
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalContinuationInterceptorMigration : kotlin.coroutines.experimental.ContinuationInterceptor {

	// *** PROPERTIES ***

	// JVM field = interceptor:Lkotlin/coroutines/ContinuationInterceptor;
	val interceptor: kotlin.coroutines.ContinuationInterceptor

	open val key: kotlin.coroutines.experimental.CoroutineContext.Key<*>
		// JVM method = getKey()Lkotlin/coroutines/experimental/CoroutineContext$Key;
		get() = /* non-default */


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/ContinuationInterceptor;)V
	/* primary */ constructor(interceptor: kotlin.coroutines.ContinuationInterceptor)


	// *** FUNCTIONS ***

	// JVM method = interceptContinuation(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
	open fun <T> interceptContinuation(continuation: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<T>
}

// ------------------------------------------------------------------------------------------------------

private class kotlin.coroutines.experimental.migration.ExperimentalContextMigration : kotlin.coroutines.experimental.AbstractCoroutineContextElement {
	...
	// JVM method = <init>(Lkotlin/coroutines/CoroutineContext;)V
	/* primary */ constructor(context: kotlin.coroutines.CoroutineContext)
}

// ------------------------------------------------------------------------------------------------------

abstract class kotlin.coroutines.experimental.jvm.internal.CoroutineImpl : kotlin.jvm.internal.Lambda<Any?>, kotlin.coroutines.experimental.Continuation<Any?> {

	// *** PROPERTIES ***

	// JVM field = _context:Lkotlin/coroutines/experimental/CoroutineContext;
	private val _context: kotlin.coroutines.experimental.CoroutineContext?

	// JVM field = _facade:Lkotlin/coroutines/experimental/Continuation;
	private var _facade: kotlin.coroutines.experimental.Continuation<Any?>?

	// JVM field = completion:Lkotlin/coroutines/experimental/Continuation;
	protected var completion: kotlin.coroutines.experimental.Continuation<Any?>?

	open val context: kotlin.coroutines.experimental.CoroutineContext
		// JVM method = getContext()Lkotlin/coroutines/experimental/CoroutineContext;
		get() = /* non-default */

	val facade: kotlin.coroutines.experimental.Continuation<Any?>
		// JVM method = getFacade()Lkotlin/coroutines/experimental/Continuation;
		get() = /* non-default */
	...
	// JVM method = <init>(ILkotlin/coroutines/experimental/Continuation;)V
	/* primary */ constructor(arity: Int, completion: kotlin.coroutines.experimental.Continuation<Any?>?)


	// *** FUNCTIONS ***

	// JVM method = create(Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
	open fun create(value: Any?, completion: kotlin.coroutines.experimental.Continuation<*>): kotlin.coroutines.experimental.Continuation<Unit>

	// JVM method = create(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
	open fun create(completion: kotlin.coroutines.experimental.Continuation<*>): kotlin.coroutines.experimental.Continuation<Unit>

	// JVM method = doResume(Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/Object;
	protected abstract fun doResume(data: Any?, exception: Throwable?): Any?

	// JVM method = resume(Ljava/lang/Object;)V
	open fun resume(value: Any?)
...
private class kotlin.coroutines.experimental.SafeContinuation.Fail {
...
abstract class kotlin.coroutines.experimental.AbstractCoroutineContextElement : kotlin.coroutines.experimental.CoroutineContext.Element {

	// *** PROPERTIES ***

	// JVM field = key:Lkotlin/coroutines/experimental/CoroutineContext$Key;
	open val key: kotlin.coroutines.experimental.CoroutineContext.Key<*>


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/experimental/CoroutineContext$Key;)V
	/* primary */ constructor(key: kotlin.coroutines.experimental.CoroutineContext.Key<*>)
}

// ------------------------------------------------------------------------------------------------------

abstract class kotlin.coroutines.experimental.SequenceBuilder<in T> {
	...
	// requires language version >= 1.1, otherwise diagnostic error
	// JVM method = yieldAll(Ljava/lang/Iterable;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	suspend fun yieldAll(elements: Iterable<in T>)
	...
	// requires language version >= 1.1, otherwise diagnostic error
	// JVM method = yieldAll(Lkotlin/sequences/Sequence;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
	suspend fun yieldAll(sequence: Sequence<in T>)
}

// ------------------------------------------------------------------------------------------------------

internal class kotlin.coroutines.experimental.CombinedContext : kotlin.coroutines.experimental.CoroutineContext {

	// *** PROPERTIES ***

	// JVM field = element:Lkotlin/coroutines/experimental/CoroutineContext$Element;
	val element: kotlin.coroutines.experimental.CoroutineContext.Element

	// JVM field = left:Lkotlin/coroutines/experimental/CoroutineContext;
	val left: kotlin.coroutines.experimental.CoroutineContext


	// *** CONSTRUCTORS ***

	// JVM method = <init>(Lkotlin/coroutines/experimental/CoroutineContext;Lkotlin/coroutines/experimental/CoroutineContext$Element;)V
	/* primary */ constructor(left: kotlin.coroutines.experimental.CoroutineContext, element: kotlin.coroutines.experimental.CoroutineContext.Element)


	// *** FUNCTIONS ***

	// JVM method = contains(Lkotlin/coroutines/experimental/CoroutineContext$Element;)Z
	private fun contains(element: kotlin.coroutines.experimental.CoroutineContext.Element): Boolean

	// JVM method = containsAll(Lkotlin/coroutines/experimental/CombinedContext;)Z
	private fun containsAll(context: kotlin.coroutines.experimental.CombinedContext): Boolean

	// JVM method = equals(Ljava/lang/Object;)Z
	open operator fun equals(other: Any?): Boolean

	// JVM method = fold(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
	open fun <R> fold(initial: R, operation: (R, kotlin.coroutines.experimental.CoroutineContext.Element) -> R): R

	// JVM method = get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;
	open operator fun <E : kotlin.coroutines.experimental.CoroutineContext.Element> get(key: kotlin.coroutines.experimental.CoroutineContext.Key<E : kotlin.coroutines.experimental.CoroutineContext.Element>): E : kotlin.coroutines.experimental.CoroutineContext.Element?

	// JVM method = hashCode()I
	open fun hashCode(): Int

	// JVM method = minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;
	open fun minusKey(key: kotlin.coroutines.experimental.CoroutineContext.Key<*>): kotlin.coroutines.experimental.CoroutineContext
...
internal class kotlin.coroutines.experimental.SafeContinuation<in T> : kotlin.coroutines.experimental.Continuation<in T> {
	...
	// JVM field = delegate:Lkotlin/coroutines/experimental/Continuation;
	private val delegate: kotlin.coroutines.experimental.Continuation<in T>
	...
	// JVM method = <init>(Lkotlin/coroutines/experimental/Continuation;)V
	internal constructor(delegate: kotlin.coroutines.experimental.Continuation<in T>)

	// JVM method = <init>(Lkotlin/coroutines/experimental/Continuation;Ljava/lang/Object;)V
	internal /* primary */ constructor(delegate: kotlin.coroutines.experimental.Continuation<in T>, initialResult: Any?)


	// *** FUNCTIONS ***

	// JVM method = getResult()Ljava/lang/Object;
	internal fun getResult(): Any?

	// JVM method = resume(Ljava/lang/Object;)V
	open fun resume(value: in T)
...
private companion object kotlin.coroutines.SafeContinuation.Companion {
	...
	// JVM annotation-holding method = RESULT$annotations()V
...
companion object kotlin.random.Random.Default : kotlin.random.Random {
	...
	// JVM field = Companion:Lkotlin/random/Random$Companion;
	// JVM annotation-holding method = Companion$annotations()V
	val Companion: kotlin.random.Random.Companion
...
object kotlin.random.Random.Companion : kotlin.random.Random {
...
internal object kotlin._Assertions {
	...
	// JVM field = ENABLED:Z
	// JVM annotation-holding method = ENABLED$annotations()V
...
object kotlin.coroutines.experimental.EmptyCoroutineContext : kotlin.coroutines.experimental.CoroutineContext {
	...
	// JVM method = plus(Lkotlin/coroutines/experimental/CoroutineContext;)Lkotlin/coroutines/experimental/CoroutineContext;
	open operator fun plus(context: kotlin.coroutines.experimental.CoroutineContext): kotlin.coroutines.experimental.CoroutineContext
...
companion object kotlin.coroutines.experimental.migration.ExperimentalContextMigration.Key : kotlin.coroutines.experimental.CoroutineContext.Key<kotlin.coroutines.experimental.migration.ExperimentalContextMigration> {
...
companion object kotlin.coroutines.experimental.migration.ContextMigration.Key : kotlin.coroutines.CoroutineContext.Key<kotlin.coroutines.experimental.migration.ContextMigration> {
...
companion object kotlin.coroutines.experimental.ContinuationInterceptor.Key : kotlin.coroutines.experimental.CoroutineContext.Key<kotlin.coroutines.experimental.ContinuationInterceptor> {
...
companion object kotlin.coroutines.experimental.SafeContinuation.Companion {

	// *** PROPERTIES ***

	// JVM field = RESULT:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
	// JVM annotation-holding method = RESULT$annotations()V
	private val RESULT: java.util.concurrent.atomic.AtomicReferenceFieldUpdater<kotlin.coroutines.experimental.SafeContinuation<*>!, Any?>!

	// JVM field = RESUMED:Ljava/lang/Object;
	private val RESUMED: Any?

	// JVM field = UNDECIDED:Ljava/lang/Object;
...
interface kotlin.reflect.KMutableProperty0.Setter<R> : kotlin.reflect.KMutableProperty.Setter<R>, (R) -> Unit
...
interface kotlin.reflect.KType : kotlin.reflect.KAnnotatedElement {
	...
	// JVM annotation-holding method = arguments$annotations()V
	abstract val arguments: List<kotlin.reflect.KTypeProjection>

	// JVM annotation-holding method = classifier$annotations()V
...
interface kotlin.reflect.KMutableProperty1.Setter<T, R> : kotlin.reflect.KMutableProperty.Setter<R>, (T, R) -> Unit
...
interface kotlin.reflect.KMutableProperty2<D, E, R> : kotlin.reflect.KProperty2<D, E, R>, kotlin.reflect.KMutableProperty<R> {
	...
	abstract val setter: kotlin.reflect.KMutableProperty2.Setter<D, E, R>
...
interface kotlin.reflect.KProperty<out R> : kotlin.reflect.KCallable<out R> {
	...
	abstract val getter: kotlin.reflect.KProperty.Getter<out R>
...
interface kotlin.reflect.KMutableProperty1<T, R> : kotlin.reflect.KProperty1<T, R>, kotlin.reflect.KMutableProperty<R> {
	...
	abstract val setter: kotlin.reflect.KMutableProperty1.Setter<T, R>


	// *** FUNCTIONS ***

	// JVM method = set(Ljava/lang/Object;Ljava/lang/Object;)V
	abstract fun set(receiver: T, value: R)
}

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KProperty2.Getter<D, E, out R> : kotlin.reflect.KProperty.Getter<out R>, (D, E) -> out R

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KMutableProperty<R> : kotlin.reflect.KProperty<R> {
	...
	abstract val setter: kotlin.reflect.KMutableProperty.Setter<R>
}
...
interface kotlin.reflect.KProperty.Getter<out R> : kotlin.reflect.KProperty.Accessor<out R>, kotlin.reflect.KFunction<out R>

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KProperty0.Getter<out R> : kotlin.reflect.KProperty.Getter<out R>, () -> out R

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KMutableProperty.Setter<R> : kotlin.reflect.KProperty.Accessor<R>, kotlin.reflect.KFunction<Unit>

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KProperty0<out R> : kotlin.reflect.KProperty<out R>, () -> out R {
	...
	abstract val getter: kotlin.reflect.KProperty0.Getter<out R>


	// *** FUNCTIONS ***

	// JVM method = get()Ljava/lang/Object;
	abstract fun get(): out R
...
interface kotlin.reflect.KProperty1.Getter<T, out R> : kotlin.reflect.KProperty.Getter<out R>, (T) -> out R

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KMutableProperty0<R> : kotlin.reflect.KProperty0<R>, kotlin.reflect.KMutableProperty<R> {
	...
	abstract val setter: kotlin.reflect.KMutableProperty0.Setter<R>
...
interface kotlin.reflect.KMutableProperty2.Setter<D, E, R> : kotlin.reflect.KMutableProperty.Setter<R>, (D, E, R) -> Unit

// ------------------------------------------------------------------------------------------------------

interface kotlin.reflect.KProperty.Accessor<out R> {

	// *** PROPERTIES ***

	abstract val property: kotlin.reflect.KProperty<out R>
}
...
interface kotlin.reflect.KProperty2<D, E, out R> : kotlin.reflect.KProperty<out R>, (D, E) -> out R {
	...
	abstract val getter: kotlin.reflect.KProperty2.Getter<D, E, out R>


	// *** FUNCTIONS ***

	// JVM method = get(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
	abstract fun get(receiver1: D, receiver2: E): out R
...
interface kotlin.reflect.KProperty1<T, out R> : kotlin.reflect.KProperty<out R>, (T) -> out R {
	...
	abstract val getter: kotlin.reflect.KProperty1.Getter<T, out R>


	// *** FUNCTIONS ***

	// JVM method = get(Ljava/lang/Object;)Ljava/lang/Object;
	abstract fun get(receiver: T): out R
...
interface kotlin.properties.ReadOnlyProperty<in R, out T> {

	// *** FUNCTIONS ***

	// JVM method = getValue(Ljava/lang/Object;Lkotlin/reflect/KProperty;)Ljava/lang/Object;
	abstract operator fun getValue(thisRef: in R, property: kotlin.reflect.KProperty<*>): out T
}

// ------------------------------------------------------------------------------------------------------

interface kotlin.properties.ReadWriteProperty<in R, T> {

	// *** FUNCTIONS ***

	// JVM method = getValue(Ljava/lang/Object;Lkotlin/reflect/KProperty;)Ljava/lang/Object;
	abstract operator fun getValue(thisRef: in R, property: kotlin.reflect.KProperty<*>): T

	// JVM method = setValue(Ljava/lang/Object;Lkotlin/reflect/KProperty;Ljava/lang/Object;)V
	abstract operator fun setValue(thisRef: in R, property: kotlin.reflect.KProperty<*>, value: T)
}
...
interface kotlin.coroutines.experimental.Continuation<in T> {

	// *** PROPERTIES ***

	abstract val context: kotlin.coroutines.experimental.CoroutineContext


	// *** FUNCTIONS ***

	// JVM method = resume(Ljava/lang/Object;)V
	abstract fun resume(value: in T)
...
interface kotlin.coroutines.experimental.CoroutineContext.Key<E : kotlin.coroutines.experimental.CoroutineContext.Element>

// ------------------------------------------------------------------------------------------------------

interface kotlin.coroutines.experimental.ContinuationInterceptor : kotlin.coroutines.experimental.CoroutineContext.Element {
	...
	// JVM method = interceptContinuation(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
	abstract fun <T> interceptContinuation(continuation: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<T>
}

// ------------------------------------------------------------------------------------------------------

interface kotlin.coroutines.experimental.CoroutineContext.Element : kotlin.coroutines.experimental.CoroutineContext {

	// *** PROPERTIES ***

	abstract val key: kotlin.coroutines.experimental.CoroutineContext.Key<*>
...
interface kotlin.coroutines.experimental.CoroutineContext {
	...
	// JVM method = fold(Ljava/lang/Object;Lkotlin/jvm/functions/Function2;)Ljava/lang/Object;
	abstract fun <R> fold(initial: R, operation: (R, kotlin.coroutines.experimental.CoroutineContext.Element) -> R): R

	// JVM method = get(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext$Element;
	abstract operator fun <E : kotlin.coroutines.experimental.CoroutineContext.Element> get(key: kotlin.coroutines.experimental.CoroutineContext.Key<E : kotlin.coroutines.experimental.CoroutineContext.Element>): E : kotlin.coroutines.experimental.CoroutineContext.Element?

	// JVM method = minusKey(Lkotlin/coroutines/experimental/CoroutineContext$Key;)Lkotlin/coroutines/experimental/CoroutineContext;
	abstract fun minusKey(key: kotlin.coroutines.experimental.CoroutineContext.Key<*>): kotlin.coroutines.experimental.CoroutineContext
...
expect annotation class kotlin.native.concurrent.SharedImmutable {
...
expect annotation class kotlin.native.concurrent.ThreadLocal {
...
expect annotation class kotlin.js.JsName {
...
annotation class kotlin.coroutines.experimental.RestrictsSuspension {
...
// JVM method = invoke()Ljava/nio/charset/CharsetDecoder;
/* local */ fun (): java.nio.charset.CharsetDecoder!
...
// JVM method = invoke()Lkotlin/collections/ShortIterator;
/* local */ fun (): ShortIterator
...
// JVM method = invoke()Lkotlin/collections/LongIterator;
/* local */ fun (): LongIterator
...
// JVM method = invoke()Lkotlin/collections/IntIterator;
/* local */ fun (): IntIterator
...
// JVM method = invoke(I)Ljava/lang/Void;
/* local */ fun <T> (it: Int): Nothing

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke()Lkotlin/collections/FloatIterator;
/* local */ fun (): FloatIterator

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke()Lkotlin/collections/CharIterator;
/* local */ fun (): CharIterator

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke()Lkotlin/collections/DoubleIterator;
/* local */ fun (): DoubleIterator
...
// JVM method = invoke()Lkotlin/collections/BooleanIterator;
/* local */ fun (): BooleanIterator

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke(Ljava/util/Map$Entry;)Ljava/lang/String;
/* local */ fun <K, out V> (it: Map.Entry<K, out V>): String

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke()Lkotlin/collections/ByteIterator;
/* local */ fun (): ByteIterator
...
/* local */ fun <T, R> (it: Sequence<R>): Iterator<R>
...
// JVM method = invoke(Ljava/lang/String;Lkotlin/coroutines/experimental/CoroutineContext$Element;)Ljava/lang/String;
/* local */ fun (acc: String, element: kotlin.coroutines.experimental.CoroutineContext.Element): String

// ------------------------------------------------------------------------------------------------------

/* lambda */

// JVM method = invoke(Lkotlin/coroutines/experimental/CoroutineContext;Lkotlin/coroutines/experimental/CoroutineContext$Element;)Lkotlin/coroutines/experimental/CoroutineContext;
/* local */ fun (acc: kotlin.coroutines.experimental.CoroutineContext, element: kotlin.coroutines.experimental.CoroutineContext.Element): kotlin.coroutines.experimental.CoroutineContext
...
// JVM annotation-holding method = coroutineContext$annotations()V
...
// JVM field = LINE_SEPARATOR_MAX_LENGTH:I
private const val LINE_SEPARATOR_MAX_LENGTH: Int

// JVM field = decoder$delegate:Lkotlin/Lazy;
private val decoder: java.nio.charset.CharsetDecoder by <delegate>
	// JVM method = getDecoder()Ljava/nio/charset/CharsetDecoder;
	get() = /* non-default */
...
// JVM method = readLine(Ljava/io/InputStream;Ljava/nio/charset/CharsetDecoder;)Ljava/lang/String;
internal fun readLine(inputStream: java.io.InputStream, decoder: java.nio.charset.CharsetDecoder): String?

// JVM method = endsWithLineSeparator(Ljava/nio/CharBuffer;)Z
private fun java.nio.CharBuffer.endsWithLineSeparator(): Boolean

// JVM method = flipBack(Ljava/nio/Buffer;)V
private fun java.nio.Buffer.flipBack()

// JVM method = offloadPrefixTo(Ljava/nio/CharBuffer;Ljava/lang/StringBuilder;)V
private fun java.nio.CharBuffer.offloadPrefixTo(builder: StringBuilder /* = java.lang.StringBuilder */)

// JVM method = tryDecode(Ljava/nio/charset/CharsetDecoder;Ljava/nio/ByteBuffer;Ljava/nio/CharBuffer;Z)Z
private fun java.nio.charset.CharsetDecoder.tryDecode(byteBuffer: java.nio.ByteBuffer, charBuffer: java.nio.CharBuffer, isEndOfStream: Boolean): Boolean
...
// JVM method = getVarContravariant(Ljava/util/Map;Ljava/lang/Object;Lkotlin/reflect/KProperty;)Ljava/lang/Object;
inline fun <V> MutableMap<in String, in V>.getValue(thisRef: Any?, property: kotlin.reflect.KProperty<*>): V
...
// JVM annotation-holding method = java$annotations(Lkotlin/reflect/KClass;)V
...
// JVM annotation-holding method = javaClass$annotations(Lkotlin/reflect/KClass;)V
...
/* facade */ class kotlin.SuccessOrFailureKt
...
@SinceKotlin(version = "1.3")
typealias SuccessOrFailure<T> = Result<T>

// ------------------------------------------------------------------------------------------------------

/* file-level declarations */

/* facade */ class kotlin.coroutines.experimental.CoroutinesKt


// *** PROPERTIES ***

// JVM annotation-holding method = coroutineContext$annotations()V
inline val coroutineContext: kotlin.coroutines.experimental.CoroutineContext
	// JVM method = getCoroutineContext()Lkotlin/coroutines/experimental/CoroutineContext;
	get() = /* non-default */


// *** FUNCTIONS ***

// JVM method = processBareContinuationResume(Lkotlin/coroutines/experimental/Continuation;Lkotlin/jvm/functions/Function0;)V
internal inline fun processBareContinuationResume(completion: kotlin.coroutines.experimental.Continuation<*>, block: () -> Any?)

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = suspendCoroutine(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
suspend inline fun <T> suspendCoroutine(crossinline block: (kotlin.coroutines.experimental.Continuation<T>) -> Unit): T

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = createCoroutine(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <T> suspend () -> T.createCoroutine(completion: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<Unit>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = createCoroutine(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <R, T> suspend R.() -> T.createCoroutine(receiver: R, completion: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<Unit>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = startCoroutine(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)V
fun <T> suspend () -> T.startCoroutine(completion: kotlin.coroutines.experimental.Continuation<T>)

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = startCoroutine(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)V
fun <R, T> suspend R.() -> T.startCoroutine(receiver: R, completion: kotlin.coroutines.experimental.Continuation<T>)

// ------------------------------------------------------------------------------------------------------

/* file-level declarations */

/* facade */ class kotlin.coroutines.experimental.migration.CoroutinesMigrationKt


// *** FUNCTIONS ***

// JVM method = toContinuation(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/Continuation;
fun <T> kotlin.coroutines.experimental.Continuation<T>.toContinuation(): kotlin.coroutines.Continuation<T>

// JVM method = toContinuationInterceptor(Lkotlin/coroutines/experimental/ContinuationInterceptor;)Lkotlin/coroutines/ContinuationInterceptor;
fun kotlin.coroutines.experimental.ContinuationInterceptor.toContinuationInterceptor(): kotlin.coroutines.ContinuationInterceptor

// JVM method = toCoroutineContext(Lkotlin/coroutines/experimental/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;
fun kotlin.coroutines.experimental.CoroutineContext.toCoroutineContext(): kotlin.coroutines.CoroutineContext

// JVM method = toExperimentalContinuation(Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <T> kotlin.coroutines.Continuation<T>.toExperimentalContinuation(): kotlin.coroutines.experimental.Continuation<T>

// JVM method = toExperimentalContinuationInterceptor(Lkotlin/coroutines/ContinuationInterceptor;)Lkotlin/coroutines/experimental/ContinuationInterceptor;
fun kotlin.coroutines.ContinuationInterceptor.toExperimentalContinuationInterceptor(): kotlin.coroutines.experimental.ContinuationInterceptor

// JVM method = toExperimentalCoroutineContext(Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/experimental/CoroutineContext;
fun kotlin.coroutines.CoroutineContext.toExperimentalCoroutineContext(): kotlin.coroutines.experimental.CoroutineContext

// JVM method = toExperimentalSuspendFunction(Lkotlin/jvm/functions/Function3;)Lkotlin/jvm/functions/Function3;
internal fun <T1, T2, R> (T1, T2, kotlin.coroutines.Continuation<R>) -> Any?.toExperimentalSuspendFunction(): (T1, T2, kotlin.coroutines.experimental.Continuation<R>) -> Any?

// JVM method = toExperimentalSuspendFunction(Lkotlin/jvm/functions/Function2;)Lkotlin/jvm/functions/Function2;
internal fun <T1, R> (T1, kotlin.coroutines.Continuation<R>) -> Any?.toExperimentalSuspendFunction(): (T1, kotlin.coroutines.experimental.Continuation<R>) -> Any?

// JVM method = toExperimentalSuspendFunction(Lkotlin/jvm/functions/Function1;)Lkotlin/jvm/functions/Function1;
internal fun <R> (kotlin.coroutines.Continuation<R>) -> Any?.toExperimentalSuspendFunction(): (kotlin.coroutines.experimental.Continuation<R>) -> Any?

// ------------------------------------------------------------------------------------------------------

/* file-level declarations */

/* facade */ class kotlin.coroutines.experimental.jvm.internal.CoroutineIntrinsics


// *** FUNCTIONS ***

// JVM method = interceptContinuationIfNeeded(Lkotlin/coroutines/experimental/CoroutineContext;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
internal fun <T> interceptContinuationIfNeeded(context: kotlin.coroutines.experimental.CoroutineContext, continuation: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<T>

// JVM method = normalizeContinuation(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <T> normalizeContinuation(continuation: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<T>
...
/* facade */ class kotlin.coroutines.experimental.intrinsics.IntrinsicsKt
...
/* facade */ class kotlin.coroutines.experimental.SequenceBuilderKt
...
// JVM annotation-holding method = COROUTINE_SUSPENDED$annotations()V
...
// JVM annotation-holding method = stackTrace$annotations(Ljava/lang/Throwable;)V
...
// JVM method = mod(Ljava/math/BigDecimal;Ljava/math/BigDecimal;)Ljava/math/BigDecimal;
inline operator fun java.math.BigDecimal.mod(other: java.math.BigDecimal): java.math.BigDecimal
...
val String.Companion.CASE_INSENSITIVE_ORDER: java.util.Comparator<String>
...
// JVM annotation-holding method = absoluteValue$annotations(D)V
inline val Double.absoluteValue: Double
	// JVM method = getAbsoluteValue(D)D
	get() = /* non-default */

// JVM annotation-holding method = absoluteValue$annotations(F)V
inline val Float.absoluteValue: Float
	// JVM method = getAbsoluteValue(F)F
	get() = /* non-default */

// JVM annotation-holding method = absoluteValue$annotations(I)V
inline val Int.absoluteValue: Int
	// JVM method = getAbsoluteValue(I)I
	get() = /* non-default */

// JVM annotation-holding method = absoluteValue$annotations(J)V
inline val Long.absoluteValue: Long
	// JVM method = getAbsoluteValue(J)J
	get() = /* non-default */

// JVM annotation-holding method = sign$annotations(D)V
inline val Double.sign: Double
	// JVM method = getSign(D)D
	get() = /* non-default */

// JVM annotation-holding method = sign$annotations(F)V
inline val Float.sign: Float
	// JVM method = getSign(F)F
	get() = /* non-default */

// JVM annotation-holding method = sign$annotations(I)V
val Int.sign: Int
	// JVM method = getSign(I)I
	get() = /* non-default */

// JVM annotation-holding method = sign$annotations(J)V
val Long.sign: Int
	// JVM method = getSign(J)I
	get() = /* non-default */

// JVM annotation-holding method = ulp$annotations(D)V
inline val Double.ulp: Double
	// JVM method = getUlp(D)D
	get() = /* non-default */

// JVM annotation-holding method = ulp$annotations(F)V
...
// JVM field = E:D
// JVM annotation-holding method = E$annotations()V
const val E: Double

// JVM field = PI:D
// JVM annotation-holding method = PI$annotations()V
const val PI: Double
...
// JVM method = buildContinuationByInvokeCall$IntrinsicsKt__IntrinsicsJvmKt(Lkotlin/coroutines/experimental/Continuation;Lkotlin/jvm/functions/Function0;)Lkotlin/coroutines/experimental/Continuation;
private inline fun <T> buildContinuationByInvokeCall(completion: kotlin.coroutines.experimental.Continuation<T>, crossinline block: () -> Any?): kotlin.coroutines.experimental.Continuation<Unit>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = createCoroutineUnchecked(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <T> suspend () -> T.createCoroutineUnchecked(completion: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<Unit>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = createCoroutineUnchecked(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
fun <R, T> suspend R.() -> T.createCoroutineUnchecked(receiver: R, completion: kotlin.coroutines.experimental.Continuation<T>): kotlin.coroutines.experimental.Continuation<Unit>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = startCoroutineUninterceptedOrReturn(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
inline fun <T> suspend () -> T.startCoroutineUninterceptedOrReturn(completion: kotlin.coroutines.experimental.Continuation<T>): Any?

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = startCoroutineUninterceptedOrReturn(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
inline fun <R, T> suspend R.() -> T.startCoroutineUninterceptedOrReturn(receiver: R, completion: kotlin.coroutines.experimental.Continuation<T>): Any?
...
// requires language version >= 1.1, otherwise diagnostic error
// JVM method = suspendCoroutineOrReturn(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
suspend inline fun <T> suspendCoroutineOrReturn(crossinline block: (kotlin.coroutines.experimental.Continuation<T>) -> Any?): T

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = suspendCoroutineUninterceptedOrReturn(Lkotlin/jvm/functions/Function1;Lkotlin/coroutines/experimental/Continuation;)Ljava/lang/Object;
suspend inline fun <T> suspendCoroutineUninterceptedOrReturn(crossinline block: (kotlin.coroutines.experimental.Continuation<T>) -> Any?): T

// JVM method = intercepted(Lkotlin/coroutines/experimental/Continuation;)Lkotlin/coroutines/experimental/Continuation;
inline fun <T> kotlin.coroutines.experimental.Continuation<T>.intercepted(): kotlin.coroutines.experimental.Continuation<T>
...
// JVM field = State_Done:I
private const val State_Done: kotlin.coroutines.experimental.State /* = Int */

// JVM field = State_Failed:I
private const val State_Failed: kotlin.coroutines.experimental.State /* = Int */

// JVM field = State_ManyNotReady:I
private const val State_ManyNotReady: kotlin.coroutines.experimental.State /* = Int */

// JVM field = State_ManyReady:I
private const val State_ManyReady: kotlin.coroutines.experimental.State /* = Int */

// JVM field = State_NotReady:I
private const val State_NotReady: kotlin.coroutines.experimental.State /* = Int */

// JVM field = State_Ready:I
private const val State_Ready: kotlin.coroutines.experimental.State /* = Int */
...
// requires language version >= 1.1, otherwise diagnostic error
// JVM method = buildIterator(Lkotlin/jvm/functions/Function2;)Ljava/util/Iterator;
fun <T> buildIterator(builderAction: suspend kotlin.coroutines.experimental.SequenceBuilder<T>.() -> Unit): Iterator<T>

// requires language version >= 1.1, otherwise diagnostic error
// JVM method = buildSequence(Lkotlin/jvm/functions/Function2;)Lkotlin/sequences/Sequence;
fun <T> buildSequence(builderAction: suspend kotlin.coroutines.experimental.SequenceBuilder<T>.() -> Unit): Sequence<T>
